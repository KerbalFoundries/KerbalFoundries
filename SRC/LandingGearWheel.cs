    ...
    public class LandingGearWheel : PartModule
    {
        ...
        public override void OnStart(PartModule.StartState state)
        {
            ...
            if (HighLogic.LoadedSceneIsFlight)
            {
                ...
                lastTempTraverse = initialTraverse.z; //sets it to a default value for the sprockets
            }
        ...
        public override void OnUpdate() 
        {
            ...
            {
                tempTraverse.z += (-wheelCollider.transform.InverseTransformPoint(hit.point).y) + wheelCollider.radius;// / wheelCollider.suspensionDistance; //out hit does not take wheel radius into account
                lastTempTraverse = tempTraverse.z;
            }
            else
            {
                tempTraverse.z = lastTempTraverse;
